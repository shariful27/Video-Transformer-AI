      ...
      <nav className="border-b border-white/5 bg-black/20 backdrop-blur-xl sticky top-0 z-50">
        <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <span className="font-bold text-xl tracking-tight">Video Transformer <span className="text-emerald-500">AI</span></span>
          </div>
      ...
      <main className="max-w-5xl mx-auto px-6 py-12">
        ...
        <div className="flex items-center justify-between mb-12 px-4">
          {(['upload', 'analyze', 'configure', 'transform', 'verify', 'complete'] as Step[]).map((s, i) => (
            <React.Fragment key={s}>
              ...
              {i < 5 && <div className="h-px flex-1 bg-white/10 mx-4" />}
            </React.Fragment>
          ))}
        </div>
        ...
        <AnimatePresence mode="wait">
          {step === 'upload' && (
            ...
            >
              <label className="block w-full aspect-[21/9] rounded-3xl border-2 border-dashed border-white/10 hover:border-emerald-500/50 bg-white/[0.02] hover:bg-emerald-500/[0.02] transition-all cursor-pointer overflow-hidden">
                ...
                <div className="absolute inset-0 flex flex-col items-center justify-center gap-4">
                  ...
                  <div className="text-center">
                    <p className="text-xl font-semibold mb-1">Upload Original Video</p>
                    <p className="text-zinc-500 text-sm">MP4, MOV or WebM up to 50MB</p>
                  </div>
                </div>
              </label>
            </motion.div>
          ...
          {step === 'analyze' && (
            ...
            >
              ...
              <div className="flex flex-col justify-center">
                <div className="space-y-4">
                  <h2 className="text-3xl font-bold tracking-tight">Ready to Transform?</h2>
                  <p className="text-zinc-400">Our AI has analyzed your video. We've identified key areas to modify to ensure your content is unique and copyright-safe.</p>
                  <button
                    onClick={() => setStep('configure')}
                    disabled={isAnalyzing}
                    className="w-full py-4 bg-emerald-500 hover:bg-emerald-600 disabled:opacity-50 text-white rounded-xl font-bold flex items-center justify-center gap-2 transition-all"
                  >
            ...
            >
              <div className="md:col-span-2 space-y-8">
                <section className="space-y-4">
                  ...
                  <div className="space-y-4 p-6 bg-white/[0.03] rounded-2xl border border-white/10">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-3 bg-black/40 border border-white/10 rounded-xl focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-all"
                    ...
                    <div>
                      ...
                      <textarea
                        ...
                        className="w-full px-4 py-3 bg-black/40 border border-white/10 rounded-xl h-24 resize-none focus:border-emerald-500 focus:ring-1 focus:ring-emerald-500 transition-all"
                        placeholder="Video description..."
                      />
                    </div>
                    <div>
                      <label className="text-xs font-bold text-zinc-500 uppercase tracking-widest block mb-2">Viral Tags</label>
                      <input
                        type="text"
                        value={tags}
                ...
                <section className="space-y-4">
                  ...
                  <div className="grid gap-4">
                    <textarea
                      ...
                      rows={4}
                      className="w-full px-4 py-3 bg-white/5 border border-white/10 rounded-xl focus:outline-none focus:border-emerald-500 transition-colors resize-none"
                    />
                  </div>
                </section>
              ...
              <div className="space-y-6">
                <div className="p-6 bg-emerald-500/5 rounded-3xl border border-emerald-500/20">
                  ...
                  <div className="space-y-4">
                    <div>
                      <label className="text-xs font-bold text-zinc-500 uppercase tracking-widest block mb-2">Watermark Text</label>
                      <input
                        type="text"
                        value={watermark}
                    ...
                    <label className="flex items-center gap-3 p-3 bg-white/5 border border-white/10 rounded-xl cursor-pointer hover:bg-white/10 transition-colors">
                      <input
                        ...
                        className="w-5 h-5 rounded border-white/20 text-emerald-500 focus:ring-emerald-500 focus:ring-offset-0 bg-black/40"
                      />
                      <div className="flex flex-col">
                        <span className="text-sm font-bold text-white">100% Copyright Safe Mode (Advanced Code Injection)</span>
                        <span className="text-xs text-zinc-400">Injects unique digital fingerprints, micro-jitter, and anti-tracking code to bypass all Content ID systems</span>
                      </div>
                    </label>
                    <button
          ...
          {step === 'verify' && (
            ...
            >
              ...
              {!isVerifying && verificationResult && (
                <div className="p-6 bg-white/[0.03] rounded-2xl border border-white/10 space-y-6">
                  <div className="prose prose-invert prose-sm max-w-none">
                    <Markdown>{verificationResult}</Markdown>
                  </div>
                  <button
                    onClick={() => setStep('complete')}
                    className="w-full py-4 bg-emerald-500 hover:bg-emerald-600 text-white rounded-xl font-bold flex items-center justify-center gap-2 transition-all"
                  >
          ...
          {step === 'complete' && (
            ...
            >
              ...
              <div className="space-y-4">
                <div className="inline-flex items-center gap-2 px-4 py-2 bg-emerald-500/10 border border-emerald-500/20 rounded-full text-emerald-400 font-medium">
                  <ShieldCheck className="w-5 h-5" />
                  Verified Copyright Free for YouTube & Facebook
                </div>
                <h2 className="text-4xl font-bold tracking-tight">Transformation Complete!</h2>
                <p className="text-zinc-400">Your video is now copyright-safe and ready for social media.</p>
              </div>
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
                <a
                  ...
                  className="px-8 py-4 bg-white text-black rounded-2xl font-bold hover:bg-zinc-200 transition-colors flex items-center gap-2"
                >
                ...
                <button
                  ...
                  disabled={isLogging}
                  className="px-8 py-4 bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 rounded-2xl font-bold hover:bg-emerald-500/20 transition-colors flex items-center gap-2"
                >
